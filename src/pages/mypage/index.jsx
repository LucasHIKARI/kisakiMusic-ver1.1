  ...
  return (
    <div style={{ width: '100%', padding: '20px' }}>
      <div /* style={{ float: "left", display: "inline-block" }} */>
        ...
        >
          <img
            src="http://p1.music.126.net/jNqRncgA_CsGWba4-0M72Q==/109951163082393914.jpg?param=185y185"
            alt="404" /* style={{ width: "90px", height: "90px" }} */
          />
        </div>
        ...
        >
          <h4>用户名：&nbsp; {username}</h4> 等级：&nbsp;{roleName}{' '}
          <Button float="right">编辑个人资料</Button>
          <Divider></Divider>
          <span>动态: 12</span>
      ...
      <div>
        <div>
          <h3 style={{ display: 'inline' }}>听歌排行</h3>
          &nbsp;&nbsp;&nbsp;&nbsp;<a>查看全部 ></a>
        </div>
        <Divider></Divider>
      ...
      <div>
        <div>
          <h3 style={{ display: 'inline' }}>我创建的歌单</h3>
          &nbsp;&nbsp;&nbsp;&nbsp;<a>查看全部 ></a>
        </div>
        <Divider></Divider>
      ...
      <div>
        <div>
          <h3 style={{ display: 'inline' }}>我收藏的歌单</h3>
          &nbsp;&nbsp;&nbsp;&nbsp;<a>查看全部 ></a>
        </div>
        <Divider></Divider>
        <ul className="main-list">
