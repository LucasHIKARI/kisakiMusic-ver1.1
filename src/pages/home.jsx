...
const columnList = [
  {
    ...
    render: (id, text, record) => {
      ...
      return (
        <span>
          <audio /* src={songUrl}  */ /* autoPlay:false */ autoPlay="false">
            {' '}
          </audio>
        </span>
      );
  ...
  },
  {
    ...
    key: 'album',
    render: (v) => {
      return <img src={v.picUrl + '?param=80y80'} alt="404" />;
    },
  },
  {
    title: '歌曲名',
        ...
        <Card /* title="图片轮播" */>
          <Carousel autoplay effect="fade">
            <div>
              <img
                style={picStyle}
                src="http://p1.music.126.net/pB7_jQC6fjmUyTUzDDQWrg==/109951168216935716.jpg?imageView&quality=89"
                alt=""
              />
            </div>
            <div>
              <img
                style={picStyle}
                src="http://p1.music.126.net/ikPM3lGUs0P4SWmCX7ZuFA==/109951168218285298.jpg?imageView&quality=89"
                alt=""
              />
            </div>
            <div>
              <img
                style={picStyle}
                src="http://p1.music.126.net/DJyF8WNuKhuSILiufILLNQ==/109951168218286622.jpg?imageView&quality=89"
                alt=""
              />
            </div>
            <div>
              <img
                style={picStyle}
                src="http://p1.music.126.net/TJ3OW9OWeupCPuDwdMgNdg==/109951168218283399.jpg?imageView&quality=89"
                alt=""
              />
            </div>
          </Carousel>
              ...
              >
                <div>
                  ...
                  >
                    <a
                      onClick={(e) => {
                        toSongListDetail(item.id, item.name);
                      }}
                    >
                      <img
      ...
      <div style={{ width: '30%', float: 'right', padding: '20px' }}>
        <div /* style={{ float: "left", display: "inline-block" }} */>
          ...
          >
            ...
            <img
              src="http://p1.music.126.net/jNqRncgA_CsGWba4-0M72Q==/109951163082393914.jpg?param=80y80"
              alt="404"
        ...
        <div>
          <div>
            <h3 style={{ display: 'inline' }}>热门电台</h3>
            &nbsp;&nbsp;&nbsp;&nbsp;<a onClick={toRadioList}>查看全部 &gt;</a>
          </div>
          <ul style={{ listStyleType: 'none', paddingLeft: '0' }}>
            <li style={liStyle}>
              <div>
                {' '}
                <img
                  src="http://p2.music.126.net/FIQXtGyweLetV-6VredoMg==/109951163336004162.jpg?param=200y200"
                  alt=""
            ...
            <li style={liStyle}>
              <div>
                {' '}
                <img
                  src="http://p2.music.126.net/fuA3-6r7ZmuVIAvnz0o-lg==/109951163257609905.jpg?param=200y200"
                  alt=""
                  style={{ height: '60px', width: '60px' }}
                />
                &nbsp;&nbsp;MEGALO BOX OST
            ...
            <li style={liStyle}>
              <div>
                {' '}
                <img
                  src="http://p2.music.126.net/xG9AiHIfj_7XQFjsFaR5Rw==/18647717209318066.jpg?param=60y60"
                  alt=""
                />
                &nbsp;&nbsp;【催眠】佛系粗暴的哄睡放松~
              </div>
            ...
            <li style={liStyle}>
              <div>
                {' '}
                <img
                  src="http://p2.music.126.net/Adi6IB5yOK8dgL16c8Zi6g==/109951165361799233.jpg?param=60y60"
                  alt=""
                />
                &nbsp;&nbsp;一千零一夜
              </div>
        ...
        <div>
          <div>
            <h3 style={{ display: 'inline' }}>入驻歌手</h3>
            &nbsp;&nbsp;&nbsp;&nbsp;查看全部 &gt;
          </div>
          <ul style={{ listStyleType: 'none', paddingLeft: '0' }}>
            <li style={liStyle2}>
              <div>
                {' '}
                <img
                  src="http://p1.music.126.net/3wbnR_0SgfYwE-HKRcKNug==/109951167338251913.jpg?param=40y40"
                  alt=""
                />
                &nbsp;&nbsp;Aimerエメ
              </div>
            ...
            <li style={liStyle2}>
              <div>
                {' '}
                <img
                  src="http://p1.music.126.net/3K51VWZVCpjI6B1P92gIlA==/109951166731394551.jpg?param=40y40"
                  alt=""
                />
                &nbsp;&nbsp;宇多田ヒカル
              </div>
            ...
            <li style={liStyle2}>
              <div>
                {' '}
                <img
                  src="http://p1.music.126.net/uRxuKxc_As2V7JtaCSyUlA==/109951163530015383.jpg?param=40y40"
                  alt=""
                />
                &nbsp;&nbsp;GUMIMegpoid
              </div>
            ...
            <li style={liStyle2}>
              <div>
                {' '}
                <img
                  src="http://p1.music.126.net/Knx1EwIBSK0jlmB2b6a6tQ==/109951167651357347.jpg?param=40y40"
                  alt=""
                />
                &nbsp;&nbsp;早见沙织
              </div>
            ...
            <li style={liStyle2}>
              <div>
                {' '}
                <img
                  src="http://p1.music.126.net/IkoxN6eVsIXMCehEr5gNPQ==/109951167493020663.jpg?param=40y40"
                  alt=""
                />
                &nbsp;&nbsp;Lisa
              </div>
...
const itemStyle = {
  ...
  overflow: 'hidden',
  background:
    '../picture/Screenshot_2017-09-29-23-37-51-606_org.tvp.kirikiri2_free.png',
};
