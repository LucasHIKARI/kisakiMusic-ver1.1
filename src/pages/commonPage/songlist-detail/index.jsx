...
export default function index() {
  ...
  useEffect(() => {
    // 歌单详情
    axios
      .get('https://cloud-music-ua22.vercel.app/playlist/detail', {
        params: {
          id: songListId,
        },
      })
    ...
    <div>
      <div style={{ width: '100%' }}>
        <div>
          ...
          <div
            style={{ width: '30%', float: 'left', display: 'inline-idblock' }}
          >
            <p>
              <span>歌单名：{SongListDetail.name}</span>
            </p>
            <p>
              <span>歌单编号：{SongListDetail.id}</span>
            </p>
