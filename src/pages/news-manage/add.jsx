...
const Add = () => {
  ...
  const handlenews = (aduitnum) => {
    axios
      ...
      .then((res) => {
        history.push(
          aduitnum === 0 ? '/news-manage/draft' : '/audit-manage/list',
        );
        notification.info({
          message: `通知`,
          description: `${
            aduitnum === 0 ? '下書き箱' : '査定リスト'
          }へ検査して下さい`,
  ...
  return (
    <div>
      <PageHeader className="site-page-header" title="新聞編集" />
      ...
      <div style={{ marginTop: '40px' }}>
        ...
        <div className={current === 2 ? '' : style.hi}></div>
      </div>
